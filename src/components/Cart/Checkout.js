...
const isEmapty = value => value.trim() == '';
...
const Checkout = (props) => {
    ...
    const confirmHandler = (event) => {
        ...
        const enteredNameIsValid = !isEmapty(enteredName);
        const enteredStreetIsValid = !isEmapty(enteredStreet);
        const enteredCityIsValid = !isEmapty(enteredCity);
    ...
    return (
        <form className={classes.form} onSubmit={confirmHandler}>
            ...
            <div className={postalCodeControlClasses}>
                ...
                {!formInputsValidity.postalCode && <p>Please enter the valid Postal Code</p>}
            </div>
